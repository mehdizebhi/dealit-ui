            ...
            <div class="card-body p-4 p-sm-5">
              ...
              <form class="mt-3 needs-validation" novalidate="">
                <div class="mb-3">
                  ...
                  <input dir="ltr" class="form-control" :type="passwordType" placeholder="رمز عبور جدید" required="" />
                </div>
                <div class="mb-3">
                  <input dir="ltr" class="form-control" :type="passwordType" placeholder="تکرار رمز عبور جدید" required="" />
                </div>
                ...
                <button class="btn btn-primary d-block w-100 mt-3 text-light" type="submit" name="submit">ویرایش رمز عبور</button>
              </form>
            </div>
          </div>
        </div>
