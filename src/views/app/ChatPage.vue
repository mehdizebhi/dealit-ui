            ...
            <div class="card-body d-flex p-0 h-100">
              ...
              <div class="tab-content card-chat-content">
                ...
                <form class="chat-editor-area">
                  ...
                  <div class="btn btn-link emoji-icon" data-emoji-button="data-emoji-button"><span class="far fa-laugh-beam"></span></div><button class="btn btn-sm btn-send shadow-none" type="submit">Send</button>
                </form>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    // connect() {},
    // disconnect() {},
    // crateStompClient(url) {
    //   const client = Stomp.over(new SockJs(url));
    //   client.onConnect = this.onConnect;
    //   client.onWebSocketError = this.onWebSocketError;
    //   client.onStompError = this.onStompError;
    // },
  },
  mounted() {
    // this.token = this.$cookies.get("token");
    // const client = crateStompClient("http://localhost:8085/v1/chat");
  },
};
</script>
